...
#' @export
#' @details Creates a motionchart of the time series of the occurrence data.
#' It uses the function \code{\link[googleVis]{gvisMotionChart}}
#' from \code{\link[googleVis]{googleVis-package}}.
#' @examples
#' \dontrun{
