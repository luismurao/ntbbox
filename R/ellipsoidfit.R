...
#' @param centroid A vector with the values of the centers of the ellipsoid (see \code{\link[ntbbox]{cov_center}}).
#' @param covar The shape matrix (covariance) of the ellipoid (see \code{\link[ntbbox]{cov_center}}).
