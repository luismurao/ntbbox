...
#' layers_stack <- raster::stack(list.files(system.file("extdata/rasters",
#'                                                      package = "ntbbox"),
...
#'
#' layers_to_proj <- raster::stack(list.files(system.file("extdata/rasters",
#'                                                       package = "ntbbox"),
...
#' \dontrun{
#'
#' pca_obj <- base::readRDS(list.files(system.file("extdata/rds",
#'                                                 package = "ntbbox"),
#'                                                 pattern = ".rds$",
#'                                                 full.names = TRUE))
#'
