...
#'
#' @description biaslayer estimates a raster that represents the sampling bias; it can be used in the \code{\link{maxent_call}{ntbbox}} function.
...
#' birds <- read.csv(system.file("extdata/csv",
#'                               "birdsN_America.csv",
#'                               package = "ntbbox"))
#' bio01 <- raster::raster(system.file("extdata/rasters",
#'                                     "bio01_bias.tif",
#'                                     package = "ntbbox"))
#'
